...
#import "GuoJia.h"
@implementation XieJiaGuiTian
static XieJiaGuiTian* sharedScene;
+(XieJiaGuiTian*)sharedScene
{
    ...
    sharedScene = [XieJiaGuiTian node];
    return sharedScene;
}
-(id)init
{
...
-(void)onEnter
{
    ...
    maxNumber = [[GuoJia sharedGuoJia]getSoldierNum];
    [super onEnter];
}
...
-(void)initLayout
{
    ...
    CCButton* confirm = [CCButton buttonWithTitle:@"确定解散这些士兵"];
...
-(void)buttonClicked:(id)button
{
    ...
    [guojia changePopulation:result];
    [guojia changeSoldier:-result];
    CCLOG(@"%i",result);
